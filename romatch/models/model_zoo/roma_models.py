...
def roma_model(
    ...
    **kwargs,
    ...
    contrastive_layers = kwargs.get("contrastive_layers")
    if contrastive_layers is not None:
        ...
        for layer_name in contrastive_layers:
            ...
            # predictor = Predictor(fea_dim, pred_dim, amp=True)
            projector_list[layer_name] = projector
            # predictor_list[layer_name] = predictor
    else:
        projector_list = None
        predictor_list = None
