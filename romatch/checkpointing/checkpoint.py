...
class CheckPoint:
    def __init__(self, dir=None, name="tmp"):
        ...
        logger.info(f"Created checkpoint at {self.dir}")
    ...
    def save(
        ...
        if romatch.RANK == 0:
            ...
            torch.save(states, self.dir + "train_roma_outdoor" + f"_{n}.pth")
            logger.info(f"Saved states {list(states.keys())}, at step {n} in {self.dir}")
